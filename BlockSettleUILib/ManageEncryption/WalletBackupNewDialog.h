#ifndef __WALLET_BACKUP_NEW_DIALOG_H__
#define __WALLET_BACKUP_NEW_DIALOG_H__
...
class WalletBackupNewDialog : public QDialog
{
   Q_OBJECT

public:
   WalletBackupNewDialog(const std::shared_ptr<bs::hd::Wallet> &
      , const std::shared_ptr<SignContainer> &
      , const std::shared_ptr<ApplicationSettings> &appSettings
      , const std::shared_ptr<spdlog::logger> &logger
      , QWidget *parent = nullptr);
   ~WalletBackupNewDialog() override;
...
private:
   std::unique_ptr<Ui::WalletBackupNewDialog> ui_;
...
#endif // __WALLET_BACKUP_NEW_DIALOG_H__

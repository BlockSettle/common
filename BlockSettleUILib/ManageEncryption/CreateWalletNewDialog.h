#ifndef __CREATE_WALLET_NEW_DIALOG_H__
#define __CREATE_WALLET_NEW_DIALOG_H__
...
class CreateWalletNewDialog : public QDialog
{
   Q_OBJECT

public:
   // Username is used to init Auth ID when available
   CreateWalletNewDialog(const std::shared_ptr<WalletsManager> &
...
private:
   std::unique_ptr<Ui::CreateWalletNewDialog> ui_;

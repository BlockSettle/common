#ifndef __ROOT_WALLET_PROPERTIES_NEWDIALOG_H__
#define __ROOT_WALLET_PROPERTIES_NEWDIALOG_H__
...
namespace Ui {
    class WalletPropertiesNewDialog;
}
namespace bs {
   namespace hd {
      class Wallet;
...
class RootWalletPropertiesNewDialog : public QDialog
{
Q_OBJECT

public:
   RootWalletPropertiesNewDialog(const std::shared_ptr<spdlog::logger> &logger
   ...
   ~RootWalletPropertiesNewDialog() override;
...
private:
   std::unique_ptr<Ui::WalletPropertiesNewDialog> ui_;
...
#endif // __ROOT_WALLET_PROPERTIES_NEWDIALOG_H__
